      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-[1.2fr_1fr_0.8fr] gap-10 md:gap-12 pt-8 sm:pt-12">
        ...
        <ul className="list-none flex flex-col gap-1">
          {[
            ...
            <li key={item.label}>
              <a href="#" className="font-mono text-[22px] sm:text-[26px] md:text-[28px] text-primary-foreground no-underline py-1.5 block font-normal tracking-[0.01em] transition-all duration-300 hover:translate-x-2 hover:text-accent">
                {item.label}
