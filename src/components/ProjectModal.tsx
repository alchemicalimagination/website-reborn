...
const projectDetails: Record<string, { description: string; works: { img: string; title: string }[] }> = {
  UGC: {
    description:
    ...
    works: [
      ...
      { img: card2, title: "Product Review" },
...
const ProjectModal = ({ isOpen, onClose, project }: ProjectModalProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={contentRef}
        className="relative z-10 w-full max-w-[680px] max-h-[85vh] mx-2 sm:mx-4 rounded-[24px] sm:rounded-[32px] overflow-hidden animate-in slide-in-from-bottom-8 fade-in duration-500"
        style={{
