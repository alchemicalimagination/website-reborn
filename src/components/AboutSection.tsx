  ...
  return (
    <section ref={ref} id="about" className="section-rounded relative h-auto min-h-[480px] sm:h-[75vh] md:h-[88vh] md:min-h-[520px] bg-sage overflow-hidden">
      ...
      <div className="relative z-[2] grid grid-cols-1 md:grid-cols-[280px_1fr_320px] items-center h-full p-6 sm:p-8 md:p-[52px] md:h-[88vh] md:min-h-[520px]">
        <div className="glass-card rounded-3xl sm:rounded-[36px] p-8 sm:p-[44px_38px] flex flex-col items-center justify-center text-center aspect-square w-[240px] sm:w-[300px] md:w-[340px]">
