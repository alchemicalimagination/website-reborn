  ...
  return (
    <section className="section-rounded bg-cream grid grid-cols-1 md:grid-cols-2 h-auto md:h-[88vh] md:min-h-[520px] border border-foreground/5">
      <div className="p-8 sm:p-10 md:p-14 flex flex-col justify-center">
        ...
        <h2 className="font-mono text-[clamp(26px,6vw,52px)] font-bold leading-[1.05] uppercase mb-4 text-dark">
      ...
      <div className="bg-gradient-to-br from-sage-light to-sage flex items-center justify-center p-8 min-h-[300px] sm:min-h-[400px]" style={{ perspective: '1100px' }}>
        <div
          className="relative preserve-3d animate-cube-float"
          style={{
            width: 'min(55vw, 38vh, 280px)',
            height: 'min(55vw, 38vh, 280px)',
            filter: 'drop-shadow(0 40px 60px rgba(0,0,0,0.15))',
          }}
        >
          {[
            { face: 'front', transform: 'translateZ(calc(min(55vw, 38vh, 280px) / 2))', img: cube1 },
            { face: 'back', transform: 'rotateY(180deg) translateZ(calc(min(55vw, 38vh, 280px) / 2))', img: cube2 },
            { face: 'right', transform: 'rotateY(90deg) translateZ(calc(min(55vw, 38vh, 280px) / 2))', img: cube3 },
            { face: 'left', transform: 'rotateY(-90deg) translateZ(calc(min(55vw, 38vh, 280px) / 2))', img: cube4 },
          ...
          <div
            ...
            style={{ transform: 'rotateX(-90deg) translateZ(calc(min(55vw, 38vh, 280px) / 2))' }}
          />
          <div
