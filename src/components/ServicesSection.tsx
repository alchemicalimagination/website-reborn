...
const ServicesSection = () => {
  ...
  return (
    <section ref={ref} className="section-rounded bg-dark h-auto min-h-[400px] sm:min-h-[480px] md:h-[88vh] md:min-h-[520px] flex flex-col items-center justify-center text-center gap-5 sm:gap-6 lg:gap-8 px-6 sm:px-10 lg:px-16 py-16 sm:py-20 lg:py-32">
