const FloatingNav = () => {
  return (
    <nav className="fixed bottom-[110px] left-1/2 -translate-x-1/2 z-[9999] flex items-center glass rounded-full p-2 whitespace-nowrap shadow-lg">
      ...
      <a
        href="#contact"
        className="bg-primary-foreground/95 text-dark py-2.5 px-[22px] rounded-full font-mono text-[11px] font-bold tracking-[0.08em] uppercase ml-2 no-underline"
      >
        Contact
      </a>
    </nav>
