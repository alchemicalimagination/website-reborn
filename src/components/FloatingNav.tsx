...
const FloatingNav = () => {
  return (
    <nav className="fixed bottom-[34px] left-1/2 -translate-x-1/2 z-[9999] flex items-center glass rounded-[100px] py-4 px-3 whitespace-nowrap shadow-lg">
      ...
      <a
        href="#contact"
        className="bg-primary-foreground/95 text-dark py-3.5 px-4 sm:px-[22px] rounded-[100px] font-mono text-[11px] font-bold tracking-[0.08em] uppercase ml-2 no-underline"
      >
        Contact
      </a>
    </nav>
