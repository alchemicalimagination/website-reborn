...
const CubeGallery = () => {
  ...
  return (
    <div ref={outerRef} className="relative" style={{ height: "600vh" }}>
      <div className="sticky top-[19px] w-full overflow-hidden bg-cream flex items-center justify-center" style={{ perspective: "1100px", borderRadius: "60px", height: "calc(100vh - 38px)" }}>
        {/* HUD */}
